package test.continuescamera.app;
...
import test.continuescamera.app.gles.EglCore;
import test.continuescamera.app.gles.FullFrameRect;
import test.continuescamera.app.gles.Texture2dProgram;
import test.continuescamera.app.gles.WindowSurface;
...
public class ContinuousCaptureActivity extends Activity implements SurfaceHolder.Callback, SurfaceTexture.OnFrameAvailableListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File mOutputDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "continuous-capture");
        if(!mOutputDir.exists()) mOutputDir.mkdir();
        String outputPath = mOutputDir.getPath() + File.separator + "Vid_" + ".mp4";
